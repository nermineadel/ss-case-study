...
```
3. Move into the Ansible deployment directory:
```bash
cd deployment/ansible
```
4. Deploy to your targeted environment (Staging or Production). Ansible will automatically read environmental overrides from group_vars/, verify the namespace exists, render the Helm variables, and safely trigger the rolling update:
